module.exports = function(exports) {
    ...
    exports.authUrl = function(redirect_uri, scope, verified_account) {
      ...
      return `https://${exports.host()}/oauth/v2/authenticate?${qs.stringify(params)}`;
    };
    ...
    exports.finishAuth = function(code, redirect_uri, fn) {
      ...
      var url = `https://${exports.host()}/oauth/v2/token`;
    ...
    exports.catalog = function(token, fn) {
      ...
      var url = `https://${exports.host()}/oauth/rest/catalog`;
